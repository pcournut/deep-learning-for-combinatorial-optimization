...
class Solver(object):
  ...
  def __init__(self, max_length):
    self.max_length = max_length          # The number of nodes
  ...
  def run(self, dist_matrix):
    ...
    routing = pywrapcp.RoutingModel(self.max_length, self.num_routes, self.depot)
    ...
    dist_between_nodes = CreateDistanceCallback(1000*dist_matrix)
    ...
    return assignment.ObjectiveValue()/1000 # optimal distance